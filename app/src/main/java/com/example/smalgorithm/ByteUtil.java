...
public class ByteUtil
{
     ...
     * @return 4个字节的自己数组
     */
    public static byte[] littleIntToBytes(int num)
    {
    ...
    public static byte[] littleShortToBytes(int num)
    {
    ...
    public static byte[] bigShortToBytes(int num)
    {
        byte[] bytes = new byte[2];
     ...
     * @return 一个整型数据
     */
    public static int byteToLittleInt(byte[] bytes)
    {
        int num = 0;
        int temp;
    ...
    public static int byteToBigInt(byte[] bytes)
    {
        int num = 0;
        int temp;
        temp = (0x000000ff & (bytes[0]));
        num = num | temp;
        temp = (0x000000ff & (bytes[1]));
        num = num<<8 | temp;
        temp = (0x000000ff & (bytes[2]));
        num = num<<8 | temp;
    ...
    public static int byteToLittleShort(byte[] bytes)
    {
        int num = 0;
        int temp;
        temp = (0x000000ff & (bytes[0]));
    ...
    public static int byteToBigShort(byte[] bytes)
    {
        int num = 0;
        int temp;
        temp = (0x000000ff & (bytes[0]));
